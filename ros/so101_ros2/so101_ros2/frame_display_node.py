...
parameter). Point any browser at http://<host>:8081/ for a fullscreen view,
or http://<host>:8081/stream for the raw MJPEG feed.
...
class FrameDisplayNode(Node):
    ...
    def __init__(self):
        ...
        # Canvas: two 640-wide panels + banner. Browsers/kiosk scale to fit.
        self._win_w = 1280
        self._win_h = 480
